...
public class TranslationServiceFog_RandomMobility_Clustering_SOM {
    ...
    static int numberOfMobileUser = Variable.numberUser;
    ...
    private static void createFogDevices(int userId, String appId) throws NumberFormatException, IOException {
        ...
        if (locator.getLevelWiseResources(locator.getLevelID("Cloud")).size() == 1) {
            ...
            FogDevice cloud = createFogDevice("cloud", 10 * 44800, 40000, 100, 10000, 0.01, 16 * 103, 16 * 83.25); // creates the fog device Cloud at the apex of the hierarchy with level=0
            ...
            for (int i = 0; i < locator.getLevelWiseResources(locator.getLevelID("Proxy")).size(); i++) {
                ...
                FogDevice proxy = createFogDevice("proxy-server_" + i, Variable.mips *  2800, Variable.ram * 4000, 10000, 10000, 0.0, 107.339, 83.4333); // creates the fog device Proxy Server (level=1)
            ...
            for (int i = 0; i < locator.getLevelWiseResources(locator.getLevelID("Gateway")).size(); i++) {
                ...
                FogDevice gateway = createFogDevice("gateway_" + i, Variable.mips * 2800, Variable.ram * 4000, 10000, 10000, 0.0, 107.339, 83.4333);

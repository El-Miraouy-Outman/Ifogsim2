...
public class FogDevice extends PowerDatacenter {
    ...
    protected void processClustering(int parentId, int nodeId, SimEvent ev) {
        ...
        //System.out.println("oooooooooooooooooooooooooooooooooooooooooo---  "+this.getId()+" --oooooooooooooooo");

        // change ici les methodes de clustering de regroupement par rapport la type de la methodes :normal ou kmeans ou som
